...
?>            
		<h2><?php echo $prefix_ct . " Totals" ?></h2>
		<table align="right" cellspacing="0" cellpadding="0">
			<tbody>

				<tr class="cart-subtotal">
		
					<th><strong><?php echo $prefix_ct . " Subtotal" ?></strong></th>
							<?php if (isset($temp_cookie) && ($temp_cookie == "container")){ ?>
					<td><strong><?php echo $container_price_all_total ?></strong></td>
					<?php } else {  ?>
				...
				<tr class="discount">
					<th><?php echo $prefix_ct . " Discount" ?> <a href="<?php echo add_query_arg('remove_discounts', '1', $woocommerce->cart->get_cart_url()) ?>"><?php _e('[Remove]', 'yit'); ?></a></th>
