...
class YITH_WCWL_Init {
		...
		public function __construct() {            
				...
				if( get_option( 'yith_wcwl_enabled' ) == 'yes' ) {
					//	add_action( 'woocommerce_after_single_product_summary', array( $this, 'add_button' ), 21 );
		...
		public function enqueue_styles_and_stuffs() {
				...
				if( !$located ) 
						...
						{ wp_enqueue_style( 'yith-wcwl-user-main', get_stylesheet_directory_uri().'/woocommerce/wishlist.css' ); }
