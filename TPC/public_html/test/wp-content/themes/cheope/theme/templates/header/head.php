...
<!-- RESET STYLESHEET -->
<link rel="stylesheet" type="text/css" media="all" href="<?php echo yit_strip_protocol( YIT_THEME_CSS_URL ) . '/reset.css'; ?>" />
<!-- BOOTSTRAP STYLESHEET -->
<link rel="stylesheet" type="text/css" media="all" href="<?php echo yit_strip_protocol( YIT_CORE_ASSETS_URL ) . '/css/bootstrap.css'; ?>" />
